 ...
 */
package com.github.naoghuman.lib.testdata.internal.i18n;
 ...
 * @since  0.1.0
 */
public class Properties implements PropertiesConfiguration {
    
    public static String getPropertyForApplication(final String propertyKey) {
