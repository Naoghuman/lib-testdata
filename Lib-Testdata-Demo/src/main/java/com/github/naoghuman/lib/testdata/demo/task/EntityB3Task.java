 ...
 * @since  0.1.0
 */
public final class EntityB3Task extends TestdataGenerationTask {
    ...
    protected Void call() throws Exception {
        LoggerFacade.getDefault().debug(this.getClass(), String.format("call(): %s", EntityB3Task.class.getSimpleName())); // NOI18N
        ...
        final CrudService crudService = DatabaseFacade.getDefault().getCrudService(EntityB3Task.class.getSimpleName());
...
//            crudService.create(ea);
    ...
    protected void setTitle() {
        super.updateTitle(EntityB3Task.class.getSimpleName());
    }
