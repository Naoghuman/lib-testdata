 ...
 * @since  0.1.0
 */
public final class EntityBTask extends TestdataGenerationTask {
    ...
    protected Void call() throws Exception {
        LoggerFacade.getDefault().debug(this.getClass(), String.format("call(): %s", EntityBTask.class.getSimpleName())); // NOI18N
    ...
    protected void setTitle() {
        super.updateTitle(EntityBTask.class.getSimpleName());
    }
