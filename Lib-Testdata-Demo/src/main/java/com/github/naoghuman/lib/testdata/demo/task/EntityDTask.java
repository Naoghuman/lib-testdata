 ...
 * @since  0.1.0
 */
public final class EntityDTask extends TestdataGenerationTask {
    ...
    protected Void call() throws Exception {
        LoggerFacade.getDefault().debug(this.getClass(), String.format("call(): %s", EntityDTask.class.getSimpleName())); // NOI18N
        ...
        final CrudService crudService = DatabaseFacade.getDefault().getCrudService(EntityDTask.class.getSimpleName());
...
//            crudService.create(ea);
    ...
    protected void setTitle() {
        super.updateTitle(EntityDTask.class.getSimpleName());
    }
