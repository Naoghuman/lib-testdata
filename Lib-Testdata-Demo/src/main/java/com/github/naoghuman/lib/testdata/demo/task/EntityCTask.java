 ...
 * @since  0.1.0
 */
public final class EntityCTask extends TestdataGenerationTask {
    ...
    protected Void call() throws Exception {
        LoggerFacade.getDefault().debug(this.getClass(), String.format("call(): %s", EntityCTask.class.getSimpleName())); // NOI18N
        ...
        final CrudService crudService = DatabaseFacade.getDefault().getCrudService(EntityCTask.class.getSimpleName());
...
//            crudService.create(ea);
    ...
    protected void setTitle() {
        super.updateTitle(EntityCTask.class.getSimpleName());
    }
