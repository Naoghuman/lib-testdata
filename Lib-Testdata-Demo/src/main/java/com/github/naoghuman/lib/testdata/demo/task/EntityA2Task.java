 ...
 * @since  0.1.0
 */
public final class EntityA2Task extends TestdataGenerationTask {
    ...
    protected Void call() throws Exception {
        LoggerFacade.getDefault().debug(this.getClass(), String.format("call(): %s", EntityA2Task.class.getSimpleName())); // NOI18N
        ...
        final CrudService crudService = DatabaseFacade.getDefault().getCrudService(EntityA2Task.class.getSimpleName());
...
//            crudService.create(ea);
    ...
    protected void setTitle() {
        super.updateTitle(EntityA2Task.class.getSimpleName());
    }
