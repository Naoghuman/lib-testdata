...
public class TemplateStartTestdataGeneration extends Application {
    ...
    public void init() throws Exception {
        ...
        entities.add(EntityContainerBuilder.create().clazz(EntityD.class) .mappingId(System.nanoTime()).configurationComponentTypeStep(ConfigurationComponentType.QUANTITY).required(EntityB.class).required(EntityB2.class).build());
        ...
        entities.add(EntityContainerBuilder.create().clazz(EntityB3.class).mappingId(System.nanoTime()).configurationComponentTypeStep(ConfigurationComponentType.QUANTITY).required(EntityD.class).required(EntityB2.class).build());
        ...
        entities.add(EntityContainerBuilder.create().clazz(EntityC.class) .mappingId(System.nanoTime()).configurationComponentTypeStep(ConfigurationComponentType.QUANTITY_TIMEPERIOD).required(EntityD.class).build());
